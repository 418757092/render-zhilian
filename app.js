...
// 环境变量
const UUID = process.env.UUID || '98f04f71-70a1-4338-ba25-77b5ddf5e539'; // 使用哪吒v1，在不同的平台部署需修改UUID，否则会覆盖
const NEZHA_SERVER = process.env.NEZHA_SERVER || 'kcystufkiiuc.ap-northeast-1.clawcloudrun.com:443';       // 哪吒v1填写形式：nz.abc.com:8008   哪吒v0填写形式：nz.abc.com
const NEZHA_PORT = process.env.NEZHA_PORT || '';           // 哪吒v1没有此变量，v0的agent端口为{443,8443,2096,2087,2083,2053}其中之一时开启tls
const NEZHA_KEY = process.env.NEZHA_KEY || '2h1TEmM79EPLBctbNrd014hWlkZ3Sr26';             // v1的NZ_CLIENT_SECRET或v0的agent端口  
